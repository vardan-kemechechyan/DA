...
//#endif
	...
	private void SetupRemoteConfig()
	{
		...
		configDefaults.Add("Timeout_10sec", true);
		configDefaults.Add("Timeout_30sec", false);
		configDefaults.Add("Timeout_45sec", false);
		configDefaults.Add("Timeout_60sec", false);

		configDefaults.Add("tutorial_5lasers", true);
		configDefaults.Add("tutorial_8lasers", false);

		configDefaults.Add("Tutorial_v1_update", false);

		configDefaults.Add("no_internet", false);

		configDefaults.Add("slowmo", true);
		configDefaults.Add("no_prior_jumps", true);

		configDefaults.Add("swipe_helper", 0);
